...
| Нажать на кнопку “Удалить” | Корзина очищается, появляется надпись “Ваша корзина пуста”. В хэдере у иконки корзины исчезает фиолетовый кружочек с цифрой-количеством добавленных товаров                                                                                                                                                                                                                                           |
...
| Шаги                                                                                                                                                                                                                      | Ожидаемый результат                                                                                                                                                                                                                                                                                                                                                                                               |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Открыта страница Избранное                                                                                                                                                                                                | Отображаются два товара: (1) картинка, название: Зауженные к низу брюки в черно-белую клетку, цена: 54.99 BYN; (2) картинка, название: Платье-худи кофейного цвета в спортивном стиле с акцентным принтом, цена: 79.99 BYN. В вверхнем левом углу у каждой картинки находится значок “Фиолетовое сердечко” в белом кружочке.                                                                                      |
...
| Шаги                                                                   | Ожидаемый результат                                                                                                                                                                                                                                                                                                   |
| ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Открыта страница товара                                                | Отображается информация о товаре: 1) Название: Платье-худи кофейного цвета в спортивном стиле с акцентным принтом, 2) Модель: 152518, 3) Цена: 79.99 BYN, 4) 5 изображений товара, описание, состав и характеристики, отзывы, 5) Размер: XS                                                                           |
|                                                                        |
